#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# F2-UZUN — dogrulama_f2_tilt_kullanimi.py'nin uzun butceli kampanya surumu.
# Karar 36 kural 3 / karar 38 bekleyen kalem. Iki fark:
#   1. KOSU_DIZIN = kosular_uzun (3M politikalar)
#   2. LIMULUS_CRUISE_ITKI=1 — politikalar bu fizikle egitildi, degerlendirme de ayni fizikle
# Metodoloji birebir ayni (seviye 2, deterministik, ablasyon+durum+genlik).
import os as _os
...
KOSU_DIZIN = os.path.join(_B, "..", "ogrenme", "kosular_uzun")
